...
class GenTest():
    ...
    def test_generated_sequence_is_correct(self):
        ...
        self.assertEqual(GenratorWithSeed('name', self.db, self.rnd).generate(' '), 'the cat sat on the mat')
    ...
    def entry(self):
        ...
        print GenratorWithSeed('name', self.db, self.rnd).generate(' ')

# genTest =  GenTest()       
# genTest.setUp()
# genTest.entry()        
# GenratorWithSeed('name', db, rnd).generate(' ')
